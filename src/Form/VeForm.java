...
public class VeForm extends javax.swing.JFrame {
    ...
    public VeForm(Object[] data, int RowID) {     
        ...
        try {
            Spin_NGBD.setValue(format.parse((String) data[7]));
    ...
    private void initComponents() {
        ...
        Spin_NGBD = new javax.swing.JSpinner(sm1);
        ...
        JSpinner.DateEditor de1 = new JSpinner.DateEditor(Spin_NGBD, "HH:mm:ss");
        Spin_NGBD.setEditor(de1);
        ...
        VePanelLayout.setVerticalGroup(
            ...
            .addGroup(VePanelLayout.createSequentialGroup()
                ...
                .addGroup(VePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Spin_NGBD, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(68, 68, 68)
                .addGroup(VePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void update(java.awt.event.MouseEvent evt) {
        ...
        Date BookDate = dc_NGAN.getDate();
        Date CreateDate = dc_NGDV.getDate();
        int TongCB = Integer.parseInt(tf_TongCB.getText());
        int TongMK = Integer.parseInt(tf_TongMK.getText());
        String Begin = tformat.format((Date) Spin_NGBD.getValue());
        ...
        try {
            ...
            p_statement.setDate(7, new java.sql.Date(((Date) Spin_NGBD.getValue()).getTime()));
            p_statement.setDate(8, new java.sql.Date(((Date) Spin_TGKT.getValue()).getTime()));
    ...
    private void add(java.awt.event.MouseEvent evt) {
        ...
        int TongCB = Integer.parseInt(tf_TongCB.getText());
        int TongMK = Integer.parseInt(tf_TongMK.getText());
        Date Begin = (Date) Spin_NGBD.getValue();
        Date End =  (Date) Spin_TGKT.getValue();
    ...
    private javax.swing.JSpinner Spin_NGBD;
